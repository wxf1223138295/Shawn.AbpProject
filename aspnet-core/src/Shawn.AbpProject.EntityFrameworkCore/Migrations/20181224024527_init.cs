    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplyCost", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _PublisherInfo_CityId = table.Column<Guid>(nullable: false),
                    _PublisherInfo_Street = table.Column<string>(nullable: true),
                    _PublisherInfo_Number = table.Column<int>(nullable: false),
                    _PublisherInfo_sss = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CenterCostBehaviorRecord", x => x.Id);
                });
