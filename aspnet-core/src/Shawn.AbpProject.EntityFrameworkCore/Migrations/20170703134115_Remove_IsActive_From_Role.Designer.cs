...
namespace Shawn.AbpProject.Migrations
{
    ...
    partial class Remove_IsActive_From_Role
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Shawn.AbpProject.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Shawn.AbpProject.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Shawn.AbpProject.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Shawn.AbpProject.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Shawn.AbpProject.Authorization.Users.User", "DeleterUser")
                        .WithMany()
